...
namespace Enki.Common
{
    ...
    {
        public const string EmailRegExp = @"(^[\w\+\=\-\.\&]+[a-zA-Z0-9]@[a-zA-Z0-9]{1}(?:[a-zA-Z0-9\-]*?|[\.]{1})[a-zA-Z0-9]{1,}(?:\.{1}[a-zA-Z0-9\-]{2,})+?$)|^([^<>]*?)<(\s*[\w\+\=\-\.\&]+[a-zA-Z0-9]@[a-zA-Z0-9]{1}(?:[a-zA-Z0-9\-]*?|[\.]{1})[a-zA-Z0-9]{1,}(?:\.{1}[a-zA-Z0-9]{2,})+?\s*)>$";
